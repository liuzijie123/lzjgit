        ...
        <tr>
            ...
            <td>
                ...
                <table cellspacing="0" class="infocontent">
                    <tr>
                        <td style="padding:20px"><p>欢迎${userInfo.username}光临商城！</p>
                            <p>

                                您有<font style="color:#FF0000">${list.size()}</font>个订单
                            ...
                            <table width="100%" border="0" cellspacing="0" class="tableopen">
                                ...
                                <c:forEach items="${list}" var="orders">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tableopentd02">${orders.receiverName}</td>
                                        <td class="tableopentd02">${orders.ordertime}</td>
                                            <%--                                                ${orders.paystate}--%>
                                        ...
                                        <td class="tableopentd03"><a
                                                href="${pageContext.request.contextPath}/ShowAllOrdersInfo?id=${orders.id}">查看</a>&nbsp;&nbsp;
                                            <a href="${pageContext.request.contextPath}/delorderID?id=${orders.id}">刪除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
