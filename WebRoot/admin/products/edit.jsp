...
<body>
	<form id="userAction_save_do" name="Form1"
		action="/redactServlet?id=${pds.id}" method="post"
		>
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="name" class="bg" value="${pds.name}" /></td>
				<td align="center" bgColor="#f5fafe" class="ta_01">商品价格：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="price" class="bg" value="${pds.price}" /></td>
			</tr>
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">商品数量：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="pnum" class="bg" value="${pds.pnum}" /></td>
				<td align="center" bgColor="#f5fafe" >商品类别：</td>
				<td class="ta_01" bgColor="#ffffff"><select name="category"
					id="category">
						<option value="${pds.category}">--选择商品类加--</option>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colSpan="3"><input
					type="file" name="imgurl" size="30" value="${pds.imgurl}" /></td>
			</tr>
			<TR>
				<TD class="ta_01" align="center" bgColor="#f5fafe">商品描述：</TD>
				<TD class="ta_01" bgColor="#ffffff" colSpan="3"><textarea
						name="description" cols="30" rows="3" style="WIDTH: 96%">${pds.description}</textarea>
				</TD>
			</TR>
			<TR>
