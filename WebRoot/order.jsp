...
<%--                                            <img src="images/buy2.gif" width="635" height="38"/>--%>
                                            <p>您好：${userInfo.username}先生！欢迎您来到商城结算中心</p></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <c:forEach items="${byProduct}" var="b" varStatus="index">

                                                <table width="100%" border="0" cellspacing="0">
                                                    <tr>
                                                        <td width="10%">${index.count}</td>
                                                        <td width="40%">${b.key.name}</td>
                                                        <td width="10%">${b.key.price}</td>
                                                        <td width="10%">${b.key.category}</td>
                                                        <td width="10%"><input name="text" type="text"
                                                                               value="${b.value}" style="width:20px"
                                                                               readonly="readonly"/></td>
                                                        <td width="10%">${b.key.price*b.value}</td>

                                                    </tr>
                                                </table>
                                                <c:set var="sum" value="${sum+b.key.price*b.value}"></c:set>
                                            </c:forEach>
                                            ...
                                            <table cellspacing="1" class="carttable">
                                                <tr>
                                                    ...
                                                    <%--																合计设置以一个name值，后端就可以获取这个值--%>
                                                            style="color:#FF0000">合计：&nbsp;&nbsp;<input name="money"
                                                                                                        type="text"
                                                                                                        value="${sum}"
                                            ...
                                            <p style="text-align:right">
                                                ...
                                                <input type="image" src="images/gif53_029.gif " width="204" ;height="51"
                                                       ;border="0">
                                                <%--													<input type="submit" style="background-image: url(images/gif53_029.gif);width:204px;height:51px;border: 0px" value="">--%>
