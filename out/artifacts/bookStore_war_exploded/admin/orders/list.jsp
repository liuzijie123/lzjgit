...
<body>
	<br>
	<form id="Form1" name="Form1" action="/OrdersLikeServlet" method="post">
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${op}" var="o">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								onmouseout="this.style.backgroundColor = '#F5FAFE';">
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="20%">${o.id}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="10%">${o.receiverName}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="15%">${o.receiverAddress}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="10%">${o.receiverPhone}</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center">
										${o.money}</td>
								<td width="8%" align="center">${o.user.username}</td>
								<td width="10%" align="center">未支付</td>

								<td align="center" style="HEIGHT: 22px"><a
									href="/OrderFindAll?id=${ids}">
										<img
										src="${pageContext.request.contextPath}/admin/images/button_view.gif"
										border="0" style="CURSOR: hand"> </a></td>
								<td align="center" style="HEIGHT: 22px">
										<a
											href="/adminDel?id=${ids}">
											<img
